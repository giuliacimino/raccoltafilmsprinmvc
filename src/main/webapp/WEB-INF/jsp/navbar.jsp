 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-primary" aria-label="Eighth navbar example">
    <div class="container">
      ...
      <sec:authorize access="isAuthenticated()">
      		      <li class="nav-item dropdown">
      		        <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Gestione Profilo</a>
      			   <div class="dropdown-menu" aria-labelledby="dropdown01">
      				
	        <p class="dropdown-item">Utente: <sec:authentication property="name"/> (${userInfo.nome } ${userInfo.cognome })
	    	 <a href="${pageContext.request.contextPath}/logout">Logout</a></p>
	    	 <a class="dropdown-item" href="${pageContext.request.contextPath}/resetpassword/prepareresetpassword">Reset Password</a>
	      </div>
      </sec:authorize>
    </div>
  </nav>
